...
Database:
- Using uploaded DB at `/mnt/data/student_info.db` (keeps existing data & schema from your Tkinter app).

Run:
1. Ensure `E:\it lab\SEM 7\full_stack\SIS\student_info.db` is present.
